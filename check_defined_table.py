...
def check_defined_table():
    ...
    try:
        ...
        print("\n=== SAMPLE DATA ===")
        cursor.execute("SELECT id, term, ngram_freq FROM defined WHERE ngram_freq IS NOT NULL LIMIT 5")
        ...
        cursor.execute("SELECT id, term, ngram_freq FROM defined WHERE ngram_freq IS NULL LIMIT 5")
